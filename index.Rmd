...
.center[
.large[
Renata Oliveira under supervision of Laetita Dablanc and Matthieu Schorung   
...
```{r echo=FALSE, message=FALSE, warning=FALSE, out.width = "105%", out.height= "100%", fig.align='center'}

htmltools::includeHTML("D:/google_drive/01_postdoc/08_review/scripts/data/img/espraia.html")
```

---

```{r echo=FALSE, fig.align='center', message=FALSE, warning=FALSE, out.height="100%", out.width="105%"}
htmltools::includeHTML("D:/google_drive/01_postdoc/08_review/scripts/data/img/fig_quad1.html")
```

---

```{r echo=FALSE, fig.align='center', message=FALSE, warning=FALSE, out.height="100%", out.width="100%"}
htmltools::includeHTML("D:/google_drive/01_postdoc/08_review/scripts/data/img/quad2.html")
```

---

```{r echo=FALSE, fig.align='center', message=FALSE, warning=FALSE, out.height="100%", out.width="100%"}
htmltools::includeHTML("D:/google_drive/01_postdoc/08_review/scripts/data/img/diff_pop.html")
```
...
Metropolitan areas for comparison

```{r include=FALSE}
quad1 <- read_csv("D:/google_drive/01_postdoc/08_review/scripts/data/data/quad1.csv")
